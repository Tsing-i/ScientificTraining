...
{
    public partial class KeyboardTemplate : UserControl
    {
        public KeyboardTemplate()
        {
            InitializeComponent();
            ...
            Task.Factory.StartNew(() =>
            {
                this.Dispatcher.Invoke(() =>
                {
                    ...
                    {
                        var template = new TemplateButton();
